...
public class RichText implements IRichText {
	...
	protected void addListeners() {
		...
		if (editorControl != null) {
			...
			/*
			 * !!!PB HACK!!!
			 * Eclipse 3.4 and greater handles key presses differently to 3.3 and so the editor is not set dirty
			 * on some key presses
			 */
			int keycode = SWT.KeyUp;
			...
			editorControl.addListener(keycode, new Listener() {
				public void handleEvent(Event event) {
